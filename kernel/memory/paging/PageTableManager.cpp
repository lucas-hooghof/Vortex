...
void PageTableManager::MapMemory(void* virtualMemory, void* physicalMemory){
    ...
    PageTable* PDP;
    if (!PDE.Present){
        PDP = (PageTable*)GlobalAllocator.AllocatePage();
        memset(PDP, 0, 0x1000);
    ...
    PageTable* PD;
    if (!PDE.Present){
        PD = (PageTable*)GlobalAllocator.AllocatePage();
        memset(PD, 0, 0x1000);
    ...
    PageTable* PT;
    if (!PDE.Present){
        PT = (PageTable*)GlobalAllocator.AllocatePage();
        memset(PT, 0, 0x1000);
